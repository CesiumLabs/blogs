        ...
        <div className="bg-theme-100 w-full text-white px-8 py-4">
            ...
            <div className="lg:flex lg:flex-nowrap">
                <div className="flex flex-nowrap">
                    ...
                    <a href="/" className="font-bold ml-2 mt-2.5 font-changa text-xl hidden sm:block cursor-pointer">
                        Snowflake Blog
                    </a>
                </div>
...
function NavbarLink({ name, href }) {
    return (
        <a href={href} className="uppercase hover:opacity-100 opacity-75 font-changa lg:ml-3 block lg:inline-block">
            {name}
        </a>
    );
}
